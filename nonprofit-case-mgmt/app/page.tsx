...
export default function Login() {
  return (
    <div className="flex flex-col mt-16 flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-center py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-10 text-center sm:items-start sm:text-center">
          <h1 className="max-w-xs -mt-90 ml-70 text-3xl font-semibold leading-10 tracking-tight text-black dark:text-zinc-50">
            Login
          </h1>
          <p className="max-w-md ml-46 text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Please enter your login information{" "}
          </p>
          <input 
             type="text" 
             placeholder="Email"
             className="w-full max-w-x ml-30 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black">
          </input>
          <input 
             type="text" 
             placeholder="Password"
             className="w-full max-w-x mt-0 ml-30 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black">
          </input>
